...
<h2 class="text-2xl font-semibold mb-4 text-purple-800">Edit Category</h2>
<hr class="h-1 mb-6 bg-purple-300">

<form action="{{ route('admin.category.update', $category->id) }}" enctype="multipart/form-data" method="POST" class="mt-5 w-1/2 mx-auto p-6 bg-gradient-to-r from-yellow-50 via-pink-100 to-orange-200 shadow-lg rounded-lg">
    @csrf
